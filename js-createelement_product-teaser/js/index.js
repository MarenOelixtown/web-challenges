...
const newProdukt = document.createElement("article");
newProdukt.classList.add("product");
newProdukt.innerHTML = `
  ...
  <span class="product__price" data-js="product-price">${price}</span>
  <button type="button" class="product__buy-button" data-js="buy-Button">Buy</button>
  </footer>`;

document.body.append(newProdukt);
